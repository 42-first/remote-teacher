	...
	<div class="rc-mask">
		...
		<template v-else>
			<section class="problemtime-box shortanswer-mask">
				<div class="tab-box" v-show="!isYanshi && studentCounts <= 3000">
...
<script>
	...
	export default {
	  ...
	  methods: {
	    ...
	    getGroupList() {
				let self = this
	      let url = API.lesson.get_classroom_group_list
      ...
      handleCreatGroup() {
				...
				if(process.env.NODE_ENV !== 'production') {
					location.href = 'http://0.0.0.0:8080/team.html#/teacher/' + self.classroomid + '?lessonid=' + self.lessonid;
        } else {
