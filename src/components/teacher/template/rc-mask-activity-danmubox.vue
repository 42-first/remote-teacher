...
<template>
    ...
    <div class="desc f20">
      <span>弹幕</span>
      <v-touch  tag="i" :class="['iconfont', 'f25', isDanmuOpen ? 'icon-danmukai' : 'icon-danmuguan']" v-on:tap="setDanmuStatus"></v-touch>
    </div>
    <div class="gap"></div>
      ...
      <div class="item-with-gap" v-for="item in danmuList" :key="item.danmu_id">
        <div class="item">
          ...
          <div class="action-box">
            ...
            <v-touch class="f15" v-show="postingDanmuid !== item.danmu_id" v-on:tap="postDanmu(item.danmu_id, item.message)"><i class="iconfont icon-tpupin f15" style="color: #639EF4;"></i>投屏</v-touch>
